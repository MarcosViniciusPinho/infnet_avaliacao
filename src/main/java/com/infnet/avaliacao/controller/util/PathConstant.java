...
public final class PathConstant {//NOSONAR desnecessário implementação que acusa o sonar.
    ...
    public static final String PATH_USUARIO_LOGADO = "/usuario";
    public static final String PATH_TEMPLATE_AVALIACAO = "/template/avaliacao";
    public static final String PATH_TEMPLATE_TOPICO = "/template/avaliacao/topico";
    public static final String PATH_RESPOSTA_AVALIACAO = "/resposta/avaliacao";
